defmodule WorkTreeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WorkTreeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WorkTreeWeb.Gettext, "errors", msg, opts)
    end
  end
