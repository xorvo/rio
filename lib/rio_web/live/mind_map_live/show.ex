defmodule RioWeb.MindMapLive.Show do
  use RioWeb, :live_view

  alias Rio.MindMaps
  alias Rio.MindMaps.Layout

  alias RioWeb.MindMapLive.{
    Navigation,
    KeyboardHandlers,
    Helpers,
    SearchHandlers,
  ...
  @impl true
  def handle_info({RioWeb.MindMapLive.NodeFormComponent, {:saved, _node}}, socket) do
    {:noreply,
     socket
     |> reload_tree()
     |> assign(:selected_node, nil)}
