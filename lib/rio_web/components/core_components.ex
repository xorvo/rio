defmodule RioWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: RioWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RioWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RioWeb.Gettext, "errors", msg, opts)
    end
  end
