defmodule WorkTree.Sync.Merger do
  @moduledoc """
  ...
  alias WorkTree.Sync.Strategies.{LastWriterWins, EditWinsOverDelete, TreeConflict}
  ...
  defp update_from_change(local_node, change) do
    ...
    updates =
      ...
      |> Enum.map(fn
        ...
        {"path", v} when is_list(v) -> {"path", WorkTree.Ecto.PathType.serialize_path(v)}
