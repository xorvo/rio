defmodule WorkTree.Exchange do
  @moduledoc """
  Public API for WorkTree data export and import using the WTXF format.
  ...
  ## Import
      ...
      {:ok, stats} = WorkTree.Exchange.import_file("backup.wtx")
      {:ok, stats} = WorkTree.Exchange.import_file("backup.wtx", mode: :merge)
  """

  alias WorkTree.Exchange.{Exporter, Importer, Format, Serializer}
