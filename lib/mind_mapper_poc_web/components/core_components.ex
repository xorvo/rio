defmodule MindMapperPocWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MindMapperPocWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MindMapperPocWeb.Gettext, "errors", msg, opts)
    end
  end
