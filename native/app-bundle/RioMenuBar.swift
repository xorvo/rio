...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private var dataDir: String {
        get {
            UserDefaults.standard.string(forKey: "dataDir")
                ?? NSHomeDirectory() + "/Library/Application Support/Rio"
        }
    ...
    private func rebuildMenu() {
        ...
        let quitItem = NSMenuItem(title: "Quit Rio", action: #selector(quitApp), keyEquivalent: "q")
    ...
    @objc private func openSettings() {
        ...
        // Note
        let note = NSTextField(wrappingLabelWithString: "Changes take effect after restarting Rio.")
